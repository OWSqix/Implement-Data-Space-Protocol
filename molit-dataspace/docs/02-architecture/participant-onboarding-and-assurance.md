...
개정 기준: 확정 결정 E-12·E-15·E-16·E-20·E-26·E-27  
상태: Draft  
관련 결정: `E-12`, `E-15`, `E-16`, `E-20`, `E-26`, `E-27`
...
- 결정 범위: D-03 참가 등급, D-04 경로 판정, D-05 강등 연결, D-06 책임 분할, D-07 인증 경계, E-12·E-15·E-16·E-20·E-21·E-26·E-27 반영
- 제외 범위: DEF-04 운영 증거 확정, 자립 전환 연한 수치(DEF-07 잔여), `DRV-01`·`DRV-02`·`DRV-04` 확정
...
- 정기 재평가(주기 연 1회 — DEF-07 결정, 2026-08-06) 또는 보안 사고·정책 위반·경로 변경·감사 지적 사건이 등록되면 해당 경로를 `REASSESSMENT_REQUIRED`로 둔다.
...
재평가 주기는 연 1회로 확정한다(DEF-07 부분 확정, Decision 2026-08-06). 자립 전환 연한 수치는 파일럿과 함께 확정한다.
...
| --- | --- | --- | --- |
| DEF-04 | [운영 신원 계층 §9의 운영 전 남은 증거](../04-implementation/operational-identity.md#9-운영-전-남은-증거) | DCP 경계를 fail-closed로 유지 — DSGA는 KAIA 잠정 지명(`E-26`, `Unverified`, 공식 확인 대기) | DSGA 공식 확인 후 후속 ADR |
| DEF-07 | 자립 전환 연한 수치 | 재평가 주기는 연 1회 확정(Decision — E-27, 2026-08-06), 사건 트리거는 즉시 적용 | 파일럿과 함께 확정 |
