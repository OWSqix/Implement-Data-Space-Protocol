...
개정 기준: 확정 결정 E-24·E-25·E-26·E-27과 2026-08-06 리서치 2건 반영  
상태: Draft  
관련 결정: `E-24`, `E-25`, `E-26`, `E-27`
...
- 2026-08-06 갱신 범위: §2의 ②·⑤·⑥·⑫ 행과 §3.2 전 행이며, 나머지 행의 확인일은 2026-07-30을 유지한다
...
| ② Use Case Development | 부분 | [요구사항 §3](../02-architecture/requirements.md#3-주요-사용사례), [실증 로드맵](../03-plan/pilot-and-roadmap.md), [KPI 기준선 선례](kpi-baseline-precedents.md) | 업무 여정·가치교환·결과 KPI가 결합된 승인 backlog 부재. DEF-06은 측정 설계만 승인되고 기준선 측정 미착수 | D-08·13·20, DEF-06 | 내부 대조 2026-08-06; 승인 backlog `Unverified` |
...
| ⑤ Organisational Form and Governance Authority | 부분 | [ADR-0007](../adr/0007-governance-function-separation.md), [구성 연구 §6](dataspace-topology-single-vs-sectoral.md#6-거버넌스-기능과-권한-계층) | Proposed 상태, 법인·법적 형태 미정. 권한 주체는 KAIA 잠정 지명이며 공식 위임 문서 미확인(OPEN-TOP-06) | D-18, DEF-01·02 | 내부 대조 2026-08-06; KAIA 위임 근거는 구두 전언 `Unverified` |
| ⑥ Participation Management | 부분 | [DSaaS §5~6](../04-implementation/dsaas-control-plane.md#5-참여기관-식별자와-connector-plan), [참가자 설계](../02-architecture/participant-onboarding-and-assurance.md) | 승인기관 Adapter·회비·이의·offboarding 보존 수치 미정. DEF-07은 재평가 주기만 확정되고 자립 전환 연한 미정 | D-03·04·05·06·07, DEF-04·07 | 내부 대조 2026-08-06; 승인기관 절차 `Unverified` |
...
| ⑫ Data Models | 부분 | [metadata §2·§4·§6](../02-architecture/metadata-and-policy-profile.md), [구현 해설](../04-implementation/molit-dcat-ap-implementation-guide.md), [정산 데이터 필드 조사](settlement-data-field-survey.md) | 분야 payload는 범주 골격만 승인. entity·field·relation·version 모델 부재, 청주 실물 조사 미실시 | D-10·11, DEF-05 | 내부 대조 2026-08-06; payload 필드 표준 `Unverified` |
...
| --- | --- | --- | --- | --- |
| DEF-01 | 운영 법인·기관 지명 | [거버넌스·운영 원칙 §6](../02-design/governance-and-operating-principles.md#6-미결정-주체와-법문화) | 공식 위임 문서 확인(OPEN-TOP-06) | KAIA 잠정 지명(Decision — E-26, 2026-08-06) — 구두 전언 근거 `Unverified`, 문서 확인 시 확정 |
| DEF-02 | 거버넌스 법적 형태·정관 | [거버넌스·운영 원칙 §6](../02-design/governance-and-operating-principles.md#6-미결정-주체와-법문화) | KAIA 공식 확인과 법무 참여 | KAIA 위임 전제 진행(Decision — E-26, 2026-08-06, 잠정·`Unverified`) — 법적 형태는 공식 확인 후 |
| DEF-03 | 회원약정·계약 법문 | [거버넌스·운영 원칙 §6](../02-design/governance-and-operating-principles.md#6-미결정-주체와-법문화) | 법무 참여 | 이 단계 착수하지 않음(Decision — E-26, 2026-08-06) — 원칙만 등록 유지 |
| DEF-04 | issuer·trust anchor·status·credential profile | [참가자 설계 §7](../02-architecture/participant-onboarding-and-assurance.md#7-미결정-등록) | DSGA 공식 확인 후 후속 ADR | DCP 경계 fail-closed — DSGA는 KAIA 잠정 지명(`E-26`, `Unverified`, 공식 확인 대기) |
| DEF-05 | payload 표준 | [분야 규약 §5](../02-design/sector-rulebook-framework.md#5-payload-표준-결정-gate) | 리서치·실물 조사(우선 후보 청주, 잠정) 완료 | 범주 골격 승인(Decision — E-24, 2026-08-06) — 필드 미결정. 리서치 [정산 데이터 필드 조사](settlement-data-field-survey.md) 반영, 기준일: 2026-08-06. 잔여 공백: 청주 실물 조사 미실시 |
| DEF-06 | KPI 수치 목표 | [초기 유즈케이스·KPI §5](../03-plan/initial-usecases-and-kpi.md#5-kpi-초안과-수치-결정) | 기준선 측정과 실증 착수 | 측정 설계 승인(Decision — E-25, 2026-08-06) — 기준선 우선. 리서치 [KPI 기준선 선례](kpi-baseline-precedents.md) 반영, 기준일: 2026-08-06. 잔여 공백: 기준선 측정 미착수 |
| DEF-07 | 재평가 주기·자립 전환 연한 수치 | [참가자 설계 §7](../02-architecture/participant-onboarding-and-assurance.md#7-미결정-등록), [거버넌스 원칙 §3](../02-design/governance-and-operating-principles.md#3-단계-자립-재원-원칙) | 자립 전환 연한은 파일럿과 함께 | 재평가 주기 연 1회 확정(Decision — E-27, 2026-08-06) — 자립 전환 연한만 미기입 |
...
§2 블록 표는 §3.2 이월 색인을 갱신할 때 같은 커밋에서 함께 갱신한다.
두 표의 확인일과 잔여 공백 표현이 어긋난 상태로 커밋하지 않는다.
