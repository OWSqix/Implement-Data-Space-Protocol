...
- **(판정)** `R-001`, `R-003~005`, `R-007~010`, `R-021`, `R-027~032`, `R-036`, `R-037`, `R-040~053`은 sponsor 처리방향 승인 전까지 상위 위험으로 유지
- **(정본 정렬: B-05)** 상세 위험 목록의 `R-053` H/H·Open 행이 현행 위험 판정이므로 상위 위험 열거에도 포함한다.
- **(가능성)** 낮음(L), 중간(M), 높음(H)
